...
export function ApiConnectionTest() {
  ...
  const runConnectionTests = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://ulaahcprp.cloud/api'}/dropdown-lists`, {
        method: 'GET',
        headers: {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://ulaahcprp.cloud/api'}/dropdown-lists/categories`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
