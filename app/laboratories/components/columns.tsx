    ...
    // Test Type
    {
      ...
      cell: ({ row }) => {
        ...
        const testTypeColors: Record<string, string> = {
          "Brucella ICT": "bg-purple-100 text-purple-800 border-purple-200",
          "Trypanosoma CATT": "bg-orange-100 text-orange-800 border-orange-200",
          "Blood Parasite Smear": "bg-red-100 text-red-800 border-red-200",
          "Internal Parasite Microscopic Examination": "bg-green-100 text-green-800 border-green-200",
          "CBC": "bg-blue-100 text-blue-800 border-blue-200",
          "Chemistry Analysis": "bg-indigo-100 text-indigo-800 border-indigo-200",
        };
        return (
          <div className="max-w-[200px]">
            <Badge className={testTypeColors[testType] || "bg-gray-100 text-gray-800 border-gray-200"}>
              {testType || 'N/A'}
            </Badge>
          </div>
        );
