...
| API الخادم | https://ahcp-backend-production.up.railway.app/api | الخادم الخلفي |
| توثيق API | https://ahcp-backend-production.up.railway.app/api-docs | Swagger Documentation |
| فحص الصحة | https://ahcp-backend-production.up.railway.app/api/health | Health Check |
